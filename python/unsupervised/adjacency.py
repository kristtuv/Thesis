...
if __name__=='__main__':
    files = ['datafiles/restart_step_1530000.data', 'datafiles/restart_step_1560000.data']
    dump_filenames = ['new_adjacency/restart_step_1530000/', 'new_adjacency/restart_step_1560000/']
    for d in dump_filenames:
        is_dir(d)
    adj = Adjacency(files)
    for neigh in range(10, 81, 10):
        adj.build_adjacency(frame=0, num_neighbors=neigh, dump_filenames=dump_filenames)
